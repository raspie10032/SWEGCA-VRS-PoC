...
Public manuscript and reference implementation for **Evidence-Gated Experience and Verified Reinforcement Synapses across Context Resets and Replaceable Reasoning Models**.
...
Public repository: [raspie10032/SWEGCA-VRS-PoC](https://github.com/raspie10032/SWEGCA-VRS-PoC), made public on 2026-09-07. It was renamed from `VRS-Judgment-PoC` with the same repository identity. The earlier name and private or then-local status in historical notes describe those checkpoints, not the current visibility; see [the rename and synchronization record](docs/REPOSITORY_RENAME_20260906.md) for the earlier operation. The separate development and raw-evidence repositories remain private.
